...
public class FindFileFrame extends JFrame {
	...
	public ArrayList<HoSo> getDanhSachHoSo() {
		return DanhSachHoSo;
	}

	public void setDanhSachHoSo(ArrayList<HoSo> danhSachHoSo) {
		DanhSachHoSo = danhSachHoSo;
	}

	private ArrayList<HoSo> DanhSachHoSo;

	public FindFileFrame() 
	{
		initialize();
		model = (DefaultTableModel) table.getModel();
		setDanhSachHoSo(BLL_Timviec.Instance().GetAllListHoSo());
		ShowHoSo();
	}
	...
	public void initialize() {
		...
		cbbTinh.setModel(new DefaultComboBoxModel(new String[]{"", "H\u00E0 N\u1ED9i", "TP H\u1ED3 Ch\u00ED Minh", "An Giang", "B\u00E0 R\u1ECBa - V\u0169ng T\u00E0u", "B\u1EAFc C\u1EA1n", "B\u1EAFc Giang", "B\u1EA1c Li\u00EAu", "B\u1EAFc Ninh", "B\u1EBFn Tre", "B\u00ECnh D\u01B0\u01A1ng", "B\u00ECnh Ph\u01B0\u1EDBc", "B\u00ECnh Thu\u1EADn", "B\u00ECnh \u0110\u1ECBnh", "C\u00E0 Mau", "C\u1EA7n Th\u01A1", "Cao B\u1EB1ng", "Gia Lai", "H\u00E0 Giang", "H\u00E0 Nam", "H\u00E0 T\u0129nh", "H\u1EA3i D\u01B0\u01A1ng", "H\u1EA3i Ph\u00F2ng", "H\u1EADu Giang", "H\u00F2a B\u00ECnh", "H\u01B0ng Y\u00EAn", "Kh\u00E1nh H\u00F2a", "Ki\u00EAn Giang", "Kon Tum", "Lai Ch\u00E2u", "L\u00E2m \u0110\u1ED3ng", "L\u1EA1ng S\u01A1n", "L\u00E0o Cai", "Long An", "Nam \u0110\u1ECBnh", "Ngh\u1EC7 An", "Ninh B\u00ECnh", "Ninh Thu\u1EADn", "Ph\u00FA Th\u1ECD", "Ph\u00FA Y\u00EAn", "Qu\u1EA3ng B\u00ECnh", "Qu\u1EA3ng Nam", "Qu\u1EA3ng Ng\u00E3i", "Qu\u1EA3ng Ninh", "Qu\u1EA3ng Tr\u1ECB", "S\u00F3c Tr\u0103ng", "S\u01A1 La", "T\u00E2y Ninh", "T			h\u00E1i B\u00ECnh", "Th\u00E1i Nguy\u00EAn", "Thanh H\u00F3a", "Th\u1EEBa Thi\u00EAn Hu\u1EBF", "Ti\u1EC1n Giang", "Tr\u00E0 Vinh", "Tuy\u00EAn Quang", "V\u0129nh Long", "V\u0129nh Ph\u00FAc", "Y\u00EAn B\u00E1i", "\u0110\u00E0 N\u1EB5ng", "\u0110\u1EAFk L\u1EAFk", "\u0110i\u1EC7n Bi\u00EAn", "\u0110\u1ED3ng Nai", "\u0110\u1ED3ng Th\u00E1p"}));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setDanhSachHoSo(BLL_Timviec.Instance().SearchHoSo(txtfullname.getText(), (String) cbbTrinhdobc.getSelectedItem(), (String) cbbloaitotnghiep.getSelectedItem(),
