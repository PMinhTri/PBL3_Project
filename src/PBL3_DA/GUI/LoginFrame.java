	...
	private void initialize() {
		...
		btnDangnhap.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try 
				{
					if(BLL_Timviec.Instance().CheckTaiKhoan(txtEmail.getText().toLowerCase().trim(), pass.getText()) == true)
					{
						if(BLL_Timviec.Instance().CheckTaiKhoanType(txtEmail.getText().toLowerCase().trim(), pass.getText()) == true)
						{
