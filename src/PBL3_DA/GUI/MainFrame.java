		...
		btnTaohs.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(BLL_Timviec.Instance().CheckHoSoById(iddangdung)==true) {
					int inform = JOptionPane.showConfirmDialog(MainFrame, 
							"hồ sơ của tài khoản đã được tạo lập sẵn! \n "
							+ "bạn có muốn cập nhật lại hồ sơ ?",
							"Thông báo",
							JOptionPane.YES_NO_OPTION,
							JOptionPane.QUESTION_MESSAGE);
					if(inform == JOptionPane.YES_OPTION) {
